...
# xml_file = glob.glob('E:/Projects_Items/Tesin/icon/forward_iconSetNum/test/*.xml')
# xml_file = glob.glob('E:/Projects_Items/Tesin/icon/forward_iconSetNum/neg/*.xml')
# xml_file = glob.glob('E:/Projects_Items/Tesin/VOCdevkitAlert/TopAlert/val/*.xml')
# xml_file = glob.glob('/home/liuyongkang/Icon32Images/P20/images/32Classes/allImages/*.xml')
# xml_file = glob.glob('/home/liuyongkang/Icon32Images/P20/images/32Classes/xmlTest/trainXML/*.xml')
# xml_file = glob.glob('D:/00_indemind_lyk/dataset/COCO/COCO/voc/val/VOC2007/Annotations/*.xml')
xml_file = glob.glob('D:/00_indemind_lyk/dataset/officeAround/allneed2/allneed2/val/*.xml')
# xml_file=['./Annotations/000032.xml']
# xml_file=['00000007_05499_d_0000037.xml']
xmlLength = len(xml_file)
print(len(xml_file), xmlLength)
random.shuffle(xml_file)
#xml_train = xml_file[:int(xmlLength*0.9)]
#xml_val = xml_file[int(xmlLength*0.9):]
#print(len(xml_train), len(xml_val))
#print(xml_file[:5])
#print(xml_train[:5])
#print(xml_file[-2:])
#print(xml_val[-2:])

PascalVOC2coco(xml_file, 'D:/00_indemind_lyk/dataset/officeAround/allneed2/allneed2/annotations/XMLtest.json')
#PascalVOC2coco(xml_val, 'Icon32val.json')
