...
from dataReaderIcon import Reader
...
def eval(model_path, min_Iou = 0.5, yolo_weights = None):
    ...
    with tf.Session() as sess:
        ...
        for index in range(len(image_files)):
            ...
            print("detect {}/{} found boxes: {},allBBox:{}".format(index, len(image_files), len(out_boxes),allBBox))
    ...
    print("The Model Eval MAP: {},prec:{},rec:{},f1:{}".format(MAP,sum_prec,sum_rec,f1))
...
if __name__ == "__main__":
    ...
    eval_neg(config.model_dir, config.neg_dir)
